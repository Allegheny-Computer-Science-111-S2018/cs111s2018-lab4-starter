...
if [ "$CHECK" = true ]; then
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labfour/ \
                                     --checkfiles WordHide.java --singlecomments 4 --multicomments 2 --language Java
  determine_exit_code $?
  # --> GatorGrader CHECK: the "new Date()" fragment exists in the code at least once
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labfour \
                                     --checkfiles WordHide.java --fragments "new Date()" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 12 "println()" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labfour \
                                     --checkfiles WordHide.java --fragments "println(" --fragmentcounts 12
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 1 "substring()" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labfour \
                                     --checkfiles WordHide.java --fragments "substring(" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 1 "charAt()" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labfour \
                                     --checkfiles WordHide.java --fragments "charAt(" --fragmentcounts 1
